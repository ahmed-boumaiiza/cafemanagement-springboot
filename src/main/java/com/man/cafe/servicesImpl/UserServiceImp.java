package com.man.cafe.servicesImpl;
        ...
        try {
            if (validateSignUpMap(requestMap)) {
                ...
                if (Objects.isNull(user)) {
                    ...
                    return CafeGenerics.getResponseEntity("Successfully Registered.", HttpStatus.OK);
                } else {
                    return CafeGenerics.getResponseEntity("Email already exists", HttpStatus.BAD_REQUEST);
                }

            } else {
                return CafeGenerics.getResponseEntity(CafeConstants.INVALID_DATA, HttpStatus.BAD_REQUEST);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
